            ...
            <%@ taglib prefix="f" uri="http://java.sun.com/jsp/jstl/fmt" %>
                ...
                <body>
                                    ...
                                    <div class="order-block" data-index="${order.status}" data-order-id="${order.id}">
                                        ...
                                        <div class="order-summary">
                                            ...
                                            <div class="order-actions">
                                                ...
                                                <c:choose>
                                                    <%-- Trạng thái 0: Chờ xác nhận (Hiện Hủy đơn, không dùng class hidden để luôn hiện đúng trạng thái) --%>
                                                    <c:when test="${order.status == 0}">
                                                        <button class="cancel" onclick="cancelOrder(${order.id})">Hủy đơn</button>
                                                    </c:when>

                                                    <%-- Trạng thái 3: Đã hoàn thành (Hiện Hoàn đơn, Ẩn Hủy đơn) --%>
                    ...
                    <script>
                        ...
                        //  Hiển thị ảnh xem trước khi người dùng Upload
                        ...
                        // Validate dữ liệu trước khi gửi về Server
