                    ...
                    <div class="content">
                        <div class="category">
                            <div class="category-menu">
                                <span onclick="toggleCategoryMenu()">Danh mục <i class="fa fa-chevron-down"
                                        id="arrow-icon"></i></span>
                                <ul id="category-list">
                                    <li><a href="${pageContext.request.contextPath}/home">TRANG CHỦ</a></li>
                                    <li><a href="${pageContext.request.contextPath}/list-product?category=all">SẢN
                                            PHẨM</a></li>
                        ...
                        <div class="product-container">
                            <h3 class="type">
                                SẢN PHẨM LIÊN QUAN: <em>${keyword}</em>
                            </h3>
