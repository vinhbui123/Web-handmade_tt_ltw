                        ...
                        <div class="inner">
                            <form action="register" method="POST">
                                ...
                                <% String error=(String) request.getAttribute("error"); String
                                    ...
                                    confirmPassword=request.getParameter("confirmPassword"); if (error==null) error="" ;
                                    if (firstName==null) firstName="" ; if (lastName==null) lastName="" ; if
                                    (username==null) username="" ; if (email==null) email="" ; if (password==null)
                                    password="" ; if (confirmPassword==null) confirmPassword="" ; %>
                                    <c:if test="${not empty error}">
                                        <div
                                            style="padding: 15px; margin: 20px 0; border-radius: 5px; font-size: 16px; color: #721c24; background-color: #f8d7da; border: 1px solid #f5c6cb;">
                                            ${error}
                                        </div>
                                    </c:if>
                                    <c:if test="${not empty success}">
                                        <div
                                            style="padding: 15px; margin: 20px 0; border-radius: 5px; font-size: 16px; color: #155724; background-color: #d4edda; border: 1px solid #c3e6cb;">
                                            ${success}
                                        </div>
                                    </c:if>
                                    ...
                                    <div class="form-wrapper">
                                        ...
                                        <input type="password" id="confirm-password" name="confirmPassword"
                                            class="form-control" value="<%= confirmPassword %>" required>
                                    </div>

                                    <div class="checkbox">
                                        <label><input type="checkbox" id="terms" name="terms" required> Tôi chấp nhận
                                            Điều khoản sử dụng & Chính sách bảo mật.</label>
                                    </div>
