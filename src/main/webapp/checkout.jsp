<%-- Created by IntelliJ IDEA. User: Admin Date: 1/6/2025 Time: 1:29 PM To change this template use File | Settings | File Templates. --%>
...
<main>
        ...
        <div class="shipping-method-section">
            <div class="note-and-shipping">
                <div class="message-box">
                    ...
                    <textarea id="message" placeholder="Lưu ý cho Người bán..." rows="5" required style="width:100%; min-height: 70px;"></textarea>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="payment-methods">
        ...
        <div class="payment-content" id="cod">
            <p>Bạn đã chọn phương thức <strong>Thanh toán khi nhận hàng</strong>. Vui lòng kiểm tra lại đơn hàng trước khi giao.</p>
        ...
        <div class="order-summary">
            <p>
            <div class="total-info total-order-value" id="total-order-value" style="display: flex;justify-content: flex-end;margin: 8px 0;font-size: 1em;">
                <span>Tổng cộng:</span>
            ...
            <p><strong>Tổng thanh toán: <span>
                    <f:formatNumber value="${sessionScope.cart.total}" pattern="#,##0 VND" />
                </span></strong></p>
        </div>
